...
# ==========================================
KP_MIN = 0.25          # Ganancia para correcciones suaves en rectas
KP_MAX = 1.2           # Ganancia máxima para curvas cerradas
FACTOR_CURVA = 0.005   # Qué tan rápido sube el Kp según el error
